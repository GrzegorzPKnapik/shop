                    ...
                    <div class="col-lg-12">
                        <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                            <div class="section-title-area ltn__section-title-2">
                                ...
                                <h1 class="section-title white-color">Edit order status</h1>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="account-login-inner">
                            <form class="ltn__form-box contact-form-box" method="POST" action="{{ route('status.update', $status->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <div class="mb-3">
                                    <label>Name:</label>
                                    <input id="name" type="text" placeholder="status" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $status->name }}" required autocomplete="name" autofocus>
                                    @error('name')
